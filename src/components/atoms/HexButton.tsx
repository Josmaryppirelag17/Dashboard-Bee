...
export const HexButton: React.FC<HexButtonProps> = ({
  ...
  const variantStyles = {
    ...
    danger: 'bg-red-50 hover:bg-red-100 text-[#b91c1c] border border-red-200 font-bold rounded-xl text-xs uppercase tracking-wider hover:shadow-[0_4px_16px_rgba(185,28,28,0.15)]'
  };
